# Development Environment - CHN ETL Demo
...
module "sqlserver_awa" {
  ...
  connection_comment = "SQL Server federation connection to Adventure Works database"
  ...
  catalog_comment = "Foreign catalog mirroring Adventure Works SQL Server database"
